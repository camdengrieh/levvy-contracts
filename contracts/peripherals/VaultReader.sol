...
contract VaultReader {
    function getVaultTokenInfoV3(address _vault, address _positionManager, address _wklay, uint256 _usdlAmount, address[] memory _tokens) public view returns (uint256[] memory) {
    ...
    function getVaultTokenInfoV4(address _vault, address _positionManager, address _wklay, uint256 _usdlAmount, address[] memory _tokens) public view returns (uint256[] memory) {
